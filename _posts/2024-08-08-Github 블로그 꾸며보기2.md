...
Ruby는 다뤄보지 않아서 chatGPT에게 도움을 받았다. 
...
이제 search 결과나 tag, category 접속 시 home 화면과 똑같은 화면으로 바꿔보자..

# Reference
1. [Jekyll 커스터마이징 - Plugin](https://namhoon.kim/2017/03/27/jekyll/024/index.html)
