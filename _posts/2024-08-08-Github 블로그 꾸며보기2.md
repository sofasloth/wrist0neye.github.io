...
image:
---
>`[2024-08-04-Github.io블로그 꾸며보기](_posts/2024-08-04-Github.io블로그%20꾸며보기.md)` github 블로그에서는 옵시디언의 **노트링크**와 **파일 embed** 기능을 지원하지 않고 github Action 빌드 실패를 일으킨다. 기회되면 이 문제점을 고쳐보려고 한다. 
...
##### 3. 노트 링크 / 임베드 기능 자동 수정 기능
현재 아래와 같은 문제가 있어서 노트 링크/임베드 기능을 사용 못 하고 있는데, 구글링을 해도 이 문제점이 잘 안 드러나있고 `ruby`나 `jekyll`에 대해서 잘 알지 못해서 이 부분은 chatGPT의 도움을 받았다.
