...
[이전 블로그 꾸미기 포스트](2024-08-04-Github.io블로그%20꾸며보기.md#Rich%20link(linkpreivew)%20구현하기)에서 rich link 구현을 실패했었는데, 위 플러그인을 설치하고 아래와 같은 문법으로 작성하면 linkpreview 링크를 만들 수 있다. 
